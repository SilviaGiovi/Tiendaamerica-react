...
export function ProductosProvider({ children }) {
    ...
    function editarProducto(producto){
        return(
            new Promise(async(res, rej) => {
            try {
                const respuesta = await fetch(`https://6827defa6b7628c529118c63.mockapi.io/Productos/${producto.id}`, {
                    method: 'PUT',
                    headers: {
                    'Content-Type': 'application/json',
                    },
    ...
    const eliminarProducto = (id) => {
        ...
        if (confirmar) {
            return(
                new Promise(async (res, rej) => {
                    try {
                        const respuesta = await fetch(`'https://6827defa6b7628c529118c63.mockapi.io/Productos'/${id}`, {
                        method: 'DELETE',
                        });
